...
export default function TaxReturnsList({ defaultStatus = 'All' }) {
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Tax Returns {selectedStatus !== 'All' ? `- ${selectedStatus}` : ''}</h1>
